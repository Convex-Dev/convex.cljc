                ...
                ($.cvm/def Init/CORE_ADDRESS
                           ($.std/merge ($.cell/* {.account.genesis   ~$.cvm/genesis-user
                                                   .gen.address       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/address)
                                                   .gen.any           ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any)
                                                   .gen.any.coll      ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any-coll)
                                                   .gen.any.list      ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any-list)
                                                   .gen.any.map       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any-map)
                                                   .gen.any.set       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any-set)
                                                   .gen.any.vector    ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/any-vector)
                                                   .gen.blob-32       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/blob-32)
                                                   .gen.boolean       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/boolean)
                                                   .gen.char          ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/char)
                                                   .gen.char-alphanum ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/char)
                                                   .gen.double        ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/double)
                                                   .gen.falsy         ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/falsy)
                                                   .gen.keyword       ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/keyword)
                                                   .gen.long          ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/long)
                                                   .gen.number        ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/number)
                                                   .gen.nil           ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/nothing)
                                                   .gen.scalar        ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/scalar)
                                                   .gen.truthy        ~($.shell.req.gen/create ($.cell/long -1)
                                                                                               $.gen/truthy)
